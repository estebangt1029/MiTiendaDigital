...
<body class="bg-slate-50 min-h-screen flex flex-col">
    ...
    <header class="bg-white border-b border-slate-200 px-4 lg:px-6 py-4 flex justify-between items-center sticky top-0 z-30 shadow-sm">
        ...
        <div class="flex items-center gap-3">
            <a href="{{ route('owner.compare') }}"
               class="hidden sm:flex items-center gap-1.5 text-sm text-slate-500 hover:text-indigo-600 transition-colors px-3 py-2 rounded-xl hover:bg-indigo-50">
