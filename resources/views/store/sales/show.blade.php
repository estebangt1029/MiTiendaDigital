    ...
    <div class="space-y-6 max-w-3xl">
            ...
            <table class="w-full text-sm">
                ...
                <tfoot class="bg-gray-50 text-sm">
                    <tr>
                        ...
                        <td class="px-4 py-3 text-right font-bold text-indigo-600">${{ number_format($sale->total, 0, ',', '.') }}</td>
                    </tr>
                    <tr>
        ...
        @if($sale->debt > 0)
            <div class="bg-white rounded-xl shadow p-5">
                ...
                <form method="POST" action="{{ route('store.payments.store', $sale) }}" class="flex gap-3 flex-wrap">
                    @csrf
                    ...
                    <div class="flex-1 min-w-32">
                        <label class="text-xs text-gray-500 mb-1 block">Nota</label>
